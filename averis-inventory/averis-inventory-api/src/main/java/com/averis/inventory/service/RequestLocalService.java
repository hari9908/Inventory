...
/**
 * Provides the local service interface for Request. Methods of this
...
public interface RequestLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.averis.inventory.service.impl.RequestLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the request local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RequestLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Request addRequest(
		ServiceContext serviceContext, String productName, long groupId,
		long userId, int quantity, long companyId, Date createDate);
	...
	public Request updateStatus(
		long userId, long leaveId, int status, ServiceContext serviceContext);
